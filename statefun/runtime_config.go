...
func NewRuntimeConfig() *RuntimeConfig {
	...
	return &RuntimeConfig{
		...
		StreamParams:                   streamParams,
		kvMutexLifeTimeSec:             system.GetEnvMustProceed("KV_MUTEX_LIFETIME_SEC", KVMutexLifetimeSec),
		kvMutexIsOldPollingIntervalSec: KVMutexIsOldPollingInterval,
		functionTypeIDLifetimeMs:       FunctionTypeIDLifetimeMs,
		requestTimeoutSec:              RequestTimeoutSec,
		natsAPITimeoutSec:              system.GetEnvMustProceed("NATS_API_TIMEOUT_SEC", NatsAPITimeoutSec),
		...
		enableTLS:                      EnableTLS,
		activePassiveMode:              system.GetEnvMustProceed("ACTIVE_PASSIVE_MODE", activePassiveMode),
