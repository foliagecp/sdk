...
func (ro *RuntimeConfig) UseJSDomainAsLocalHubDomainName() *RuntimeConfig {
	ro.desiredLocalHUBDomainName = "" // empty string means auto fill with current domain name from nats
	return ro
}
