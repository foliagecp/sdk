...
func CreateTestGraph(runtime *statefun.Runtime) {
	...
	system.MsgOnErrorReturn(dbClient.Graph.VertexLinkCreate("rt", "a", "2a", "type1", []string{"t1", "t2"}, lb1))
	...
	system.MsgOnErrorReturn(dbClient.Graph.VertexLinkCreate("rt", "b", "2b", "type2", []string{"t2"}, lb2))
	...
	system.MsgOnErrorReturn(dbClient.Graph.VertexLinkCreate("rt", "c", "2c", "type1", nil, lb3))
